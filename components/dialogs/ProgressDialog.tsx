...
interface FileUploadProgressDialogProps extends Omit<ProgressDialogProps, 'type' | 'title'> {
  fileName?: string;
  fileSize?: string;
  uploadSpeed?: string;
}
...
interface QuestionProcessingDialogProps extends Omit<ProgressDialogProps, 'type' | 'title'> {
...
interface AIEvaluationDialogProps extends Omit<ProgressDialogProps, 'type' | 'title'> {
...
interface DatabaseOperationDialogProps extends Omit<ProgressDialogProps, 'type' | 'title'> {
