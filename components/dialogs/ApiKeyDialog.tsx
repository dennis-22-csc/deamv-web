        ...
        <div className="space-y-3">
          ...
          <div className="relative">
            <Input
              ...
              variant="outlined"
              fullWidth
              // FIX: Pass the icon as a JSX element instead of a component reference
              // This is a common workaround when a component expects a ReactNode for an icon prop
              // but the original code was passing the component function itself.
