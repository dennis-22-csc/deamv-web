...
interface LayoutProps {
  ...
  variant?: 'default' | 'centered' | 'practice' | 'fullscreen';
  className?: string;
  headerProps?: {
    title?: string;
...
const Layout: React.FC<LayoutProps> = ({
  ...
  const layoutVariant = variant === 'default' ? getAutoVariant() : variant;
...
interface LayoutContextType {
  ...
  setLayout: (layout: LayoutProps['variant']) => void;
}
...
interface LayoutProviderProps {
  children: React.ReactNode;
  defaultLayout?: LayoutProps['variant'];
}
...
const LayoutProvider: React.FC<LayoutProviderProps> = ({
  ...
  const [currentLayout, setCurrentLayout] = React.useState<LayoutProps['variant']>(defaultLayout);
...
export type { LayoutProps, CenteredLayoutProps, PracticeLayoutProps };
